...
StructuredBuffer<float4x4> sbColorTransform <string uiname="Color Transform";>;
...
cbuffer cbPerDraw : register( b0 )
{
	...
	int tcolorcount <string uiname="Color Transform Count";> = 1;
};
...
vs2ps VS(VS_IN input)
{
	...
	Out.Color = mul(sbColor[input.ii % colorcount], sbColorTransform[input.ii % tcolorcount]);
